...
from .views import (
    ...
    TaskDeliverableDetailView,
    TaskDeliverableListCreateView,
    TaskDetailView,
    TaskListCreateView,
    TaskReviewView,
...
urlpatterns = [
    ...
    path("tasks/<int:pk>/review/", TaskReviewView.as_view()),
    path("tasks/<int:pk>/deliverables/", TaskDeliverableListCreateView.as_view()),
    path("task-deliverables/<int:pk>/", TaskDeliverableDetailView.as_view()),
